  ...
  return (
    <section className="grid min-h-[min(760px,calc(100vh-36px))] w-full max-w-[1200px] items-center gap-8 rounded-3xl border border-[#202020] bg-[radial-gradient(circle_at_18%_8%,rgba(126,255,175,0.12),transparent_22rem),linear-gradient(145deg,rgba(11,22,12,0.96),rgba(0,0,0,0.94)_48%,rgba(6,14,7,0.96))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.6)] sm:p-10 lg:grid-cols-[minmax(0,1fr)_minmax(320px,440px)] lg:gap-16 xl:p-[72px]">
      <div className="max-w-xl">
        ...
        <p className="mb-3 max-w-[470px] text-base leading-7 text-[#daffde]/70 sm:text-lg">
        ...
        <p className="max-w-[470px] text-base leading-7 text-[#daffde]/70 sm:text-lg">
          We save only the browser session data needed to keep you signed in.
        </p>
      </div>

      <AuthTabs authMode={authMode} onModeChange={onModeChange} />

      <form
        className="grid gap-4 self-start rounded-2xl border border-[#222] bg-[#0b0b0b] p-5 lg:col-start-2 lg:p-8"
        onSubmit={onSubmit}
      >
        <FormField
